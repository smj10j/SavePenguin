...
#define HUD_BUTTON_MARGIN_TOP 14*SCALING_FACTOR
#define HUD_BUTTON_MARGIN_LEFT 20*SCALING_FACTOR

#define TOOLBOX_MARGIN_TOP 10*SCALING_FACTOR
#define TOOLBOX_MARGIN_LEFT 20*SCALING_FACTOR
#define TOOLBOX_ITEM_CONTAINER_PADDING 20*SCALING_FACTOR
#define TOOLBOX_ITEM_CONTAINER_COUNT_FONT_SIZE 16
